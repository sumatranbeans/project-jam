  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="bg-white p-8 rounded-2xl shadow-lg max-w-md w-full text-center">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2">Project Jam</h1>
        <p className="text-gray-500 mb-8">Claude builds • Gemini supervises</p>
        ...
        <p className="mt-6 text-xs text-gray-400">
          Your projects and API keys are private and encrypted.
        </p>
      </div>
    </main>
  )
